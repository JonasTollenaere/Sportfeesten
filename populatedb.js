...
function createSpelers(cb) {
    async.parallel([
        function(callback) {
          spelerCreate('Robbe', 'Beemster', '1973-06-06', locaties[2], callback);
        },
        function(callback) {
            spelerCreate('Ben', 'Bakman', '1932-11-8', locaties[1], callback);
        },
        function(callback) {
            spelerCreate('Jonas', 'Courtois', '1920-01-02', locaties[0], callback);
        },
        function(callback) {
            spelerCreate('Bob', 'Billings', '1998-02-12', locaties[4], callback);
        },
        function(callback) {
            spelerCreate('Jim', 'Jones', '1971-12-16', locaties[4], callback);
        },
        function (callback) {
            spelerCreate('Elien', 'Triptrap', '1971-12-16', locaties[3], callback);
        },
        ],
        // optional callback
        cb);
...
function createLocaties(cb) {
    async.parallel([
        function(callback) {
            locatieCreate("Temse","Oost-Vlaanderen", 9140, "Melige beschrijving nr.1",  callback)
        },
        function(callback) {
